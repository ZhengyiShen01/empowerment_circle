...
import '/components/modal_task_create/modal_task_create_widget.dart';
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                                  ...
                                  if (widget.projectRef!.owner ==
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MODAL_PROJECT_DETAILS_edit_rounded_ICN_O');
                                          logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'MODAL_PROJECT_DETAILS_close_rounded_ICN_');
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MODAL_PROJECT_DETAILS_Row_bo06fybw_ON_TA');
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                updateCount: (count) async {
                                  ...
                                  logFirebaseEvent(
                                      'MODAL_PROJECT_DETAILS_CountController_i8');
                                  logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                updateCount: (count) async {
                                  ...
                                  logFirebaseEvent(
                                      'MODAL_PROJECT_DETAILS_CountController_mw');
                                  logFirebaseEvent(
                                      'CountController_backend_call');
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MODAL_PROJECT_DETAILS_Container_vysw9jxy');
                                                logFirebaseEvent(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MODAL_PROJECT_DETAILS_Container_cj8cngnk');
                                                logFirebaseEvent(
                                                    'Container_bottom_sheet');
                                                await showModalBottomSheet(
                                                  isScrollControlled: true,
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'MODAL_PROJECT_DETAILS_Container_bhjlux9n');
                                                  logFirebaseEvent(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'MODAL_PROJECT_DETAILS_ADD_CHALLENGE_BTN_');
