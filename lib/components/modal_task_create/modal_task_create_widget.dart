...
import 'modal_task_create_model.dart';
export 'modal_task_create_model.dart';

class ModalTaskCreateWidget extends StatefulWidget {
  const ModalTaskCreateWidget({
    Key? key,
  ...
  @override
  _ModalTaskCreateWidgetState createState() => _ModalTaskCreateWidgetState();
}

class _ModalTaskCreateWidgetState extends State<ModalTaskCreateWidget> {
  late ModalTaskCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalTaskCreateModel());
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'MODAL_TASK_CREATE_Container_maigolkr_ON_');
                                      logFirebaseEvent(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MODAL_TASK_CREATE_ADD_ANOTHER_ONE_BTN_ON');
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MODAL_TASK_CREATE_COMP_DONE_BTN_ON_TAP');
                                      logFirebaseEvent('Button_validate_form');
                                      if (_model.formKey.currentState == null ||
                                          !_model.formKey.currentState!
                                              .validate()) {
