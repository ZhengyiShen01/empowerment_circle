...
class _ModalCreateProjectWidgetState extends State<ModalCreateProjectWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MODAL_CREATE_PROJECT_modal_CreateProject');
      logFirebaseEvent('modal_CreateProject_update_app_state');
      setState(() {
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'MODAL_CREATE_PROJECT_CREATE_PROJECT_BTN_');
