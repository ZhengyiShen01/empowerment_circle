          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('DRAWER_NAV_COMP_VIEW_BTN_ON_TAP');
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'DRAWER_NAV_COMP_Row_rpn9aw94_ON_TAP');
                          logFirebaseEvent('Row_drawer');
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'DRAWER_NAV_COMP_Row_q2pral92_ON_TAP');
                          logFirebaseEvent('Row_drawer');
                          if (Scaffold.of(context).isDrawerOpen ||
                              Scaffold.of(context).isEndDrawerOpen) {
                            Navigator.pop(context);
                          ...
                          context.pushNamed('Main_projects');
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'DRAWER_NAV_COMP_Row_klpjc0k0_ON_TAP');
                          logFirebaseEvent('Row_drawer');
                          if (Scaffold.of(context).isDrawerOpen ||
                              Scaffold.of(context).isEndDrawerOpen) {
                            Navigator.pop(context);
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('DRAWER_NAV_COMP_Row_qnfbsrfe_ON_TAP');
                  logFirebaseEvent('Row_drawer');
                  if (Scaffold.of(context).isDrawerOpen ||
                      Scaffold.of(context).isEndDrawerOpen) {
                    Navigator.pop(context);
