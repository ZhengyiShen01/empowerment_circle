                                        ...
                                        child: FutureBuilder<ProjectsRecord>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'MODAL_TASK_DETAILS_Row_rtut46js_ON_TAP');
                                                logFirebaseEvent(
                                                    'Row_bottom_sheet');
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child:
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'MODAL_TASK_DETAILS_close_rounded_ICN_ON_');
                                                        logFirebaseEvent(
                                                ...
                                                if (widget.taskRef!.owner ==
                                                  ...
                                                  Padding(
                                                    ...
                                                    child:
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'MODAL_TASK_DETAILS_edit_rounded_ICN_ON_T');
                                                        logFirebaseEvent(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'MODAL_TASK_DETAILS_markComplete_ON_TAP');
                                                              logFirebaseEvent(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'MODAL_TASK_DETAILS_COMP_accept_ON_TAP');
                                                              // changeStatus
                                                              logFirebaseEvent(
                                                                  'accept_changeStatus');
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'MODAL_TASK_DETAILS_person_add_ICN_ON_TAP');
                                                logFirebaseEvent(
                                                    'IconButton_bottom_sheet');
                                                await showModalBottomSheet(
                                                  isScrollControlled: true,
                                              ...
                                              child: FutureBuilder<UsersRecord>(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'MODAL_TASK_DETAILS_COMP_ProPlan_ON_TAP');
                                                      logFirebaseEvent(
                                                        ...
                                                        if (rowUsersRecord
                                                          ...
                                                          FlutterFlowIconButton(
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'MODAL_TASK_DETAILS_delete_outlined_ICN_O');
                                                              logFirebaseEvent(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'MODAL_TASK_DETAILS_SUBMIT_BTN_ON_TAP');
                                        ...
                                        await widget.taskRef!.reference.update({
