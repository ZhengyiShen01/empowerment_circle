                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'MODAL_TASK_CREATE_1_close_rounded_ICN_ON');
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'MODAL_TASK_CREATE_1_ADD_PROJECT_BTN_ON_T');
                    ...
                    child: FutureBuilder<List<ProjectsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return RefreshIndicator(
                          onRefresh: () async {
                            logFirebaseEvent(
                                'MODAL_TASK_CREATE_1_ListView_5w21x8fb_ON');
                            logFirebaseEvent(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MODAL_TASK_CREATE_1_Container_o214qypv_O');
