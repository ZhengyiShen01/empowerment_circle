...
class _AddTeamMembersWidgetState extends State<AddTeamMembersWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'addTeamMembers'});
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'ADD_TEAM_MEMBERS_close_rounded_ICN_ON_TA');
                        ...
                        children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'ADD_TEAM_MEMBERS_PAGE_userImage_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.teamSelectValueController ??=
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'ADD_TEAM_MEMBERS_CREATE_&_INVITE_USER_BT');
