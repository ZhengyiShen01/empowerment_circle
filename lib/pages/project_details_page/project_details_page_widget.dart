...
class _ProjectDetailsPageWidgetState extends State<ProjectDetailsPageWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'projectDetailsPage'});
    setupAnimations(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                logFirebaseEvent('PROJECT_DETAILS_FloatingActionButton_ys7');
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROJECT_DETAILS_arrow_back_rounded_ICN_O');
                        ...
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'PROJECT_DETAILS_edit_rounded_ICN_ON_TAP');
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'PROJECT_DETAILS_Row_hkxc2efl_ON_TAP');
                              ...
                              child: Container(
                                ...
                                child: FlutterFlowCountController(
                                  ...
                                  updateCount: (count) async {
                                    ...
                                    logFirebaseEvent(
                                        'PROJECT_DETAILS_CountController_7dy16ujp');
                                    logFirebaseEvent(
                              ...
                              child: Container(
                                ...
                                child: FlutterFlowCountController(
                                  ...
                                  updateCount: (count) async {
                                    ...
                                    logFirebaseEvent(
                                        'PROJECT_DETAILS_CountController_rtsef6rv');
                                    logFirebaseEvent(
                                        'CountController_backend_call');
                                          ...
                                          itemBuilder:
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'PROJECT_DETAILS_Container_ekz19b20_ON_TA');
                                                  logFirebaseEvent(
                                          ...
                                          itemBuilder:
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'PROJECT_DETAILS_Container_deic0mv9_ON_TA');
                                                  logFirebaseEvent(
                                                      'Container_navigate_to');
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'PROJECT_DETAILS_Container_89pcqqwq_ON_TA');
                                                    logFirebaseEvent(
