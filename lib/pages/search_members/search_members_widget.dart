...
class _SearchMembersWidgetState extends State<SearchMembersWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'searchMembers'});
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SEARCH_MEMBERS_search_rounded_ICN_ON_TAP');
                          ...
                          itemBuilder: (context, searchResultsIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SEARCH_MEMBERS_PAGE_currentList_ON_TAP');
                                  logFirebaseEvent('currentList_navigate_to');
                                      ...
                                      children: [
                                        ...
                                        if (!widget.projectRef!.usersAssigned
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'SEARCH_MEMBERS_PAGE_ASSIGN_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_backend_call');
