...
class _MainTrackerWidgetState extends State<MainTrackerWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_tracker'});
    setupAnimations(
          ...
          child: Scaffold(
            ...
            floatingActionButton: Visibility(
              ...
              child: FloatingActionButton(
                onPressed: () async {
                  logFirebaseEvent('MAIN_TRACKER_FloatingActionButton_qb9h4x');
                            ...
                            if (responsiveVisibility(
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'MAIN_TRACKER_PAGE_MAKE_A_WISH_BTN_ON_TAP');
                                                              ...
                                                              return Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'MAIN_TRACKER_Container_flgmhmtq_ON_TAP');
                                                                    logFirebaseEvent(
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          return RefreshIndicator(
                                                            onRefresh:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'MAIN_TRACKER_ListView_aqooygrt_ON_PULL_T');
                                                              logFirebaseEvent(
                                                                ...
                                                                return Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'MAIN_TRACKER_Container_ewogb7o7_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Container_bottom_sheet');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          return RefreshIndicator(
                                                            onRefresh:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'MAIN_TRACKER_ListView_kat5e7wv_ON_PULL_T');
                                                              logFirebaseEvent(
                                                                  'ListView_refresh_database_request');
                                                              setState(() =>
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        return Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'MAIN_TRACKER_Container_ryutzfxw_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Container_bottom_sheet');
                                                              await showModalBottomSheet(
                                                                isScrollControlled:
                                                ...
                                                child: FutureBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return RefreshIndicator(
                                                      onRefresh: () async {
                                                        logFirebaseEvent(
                                                            'MAIN_TRACKER_ListView_4crc445y_ON_PULL_T');
                                                        logFirebaseEvent(
                                                            'ListView_refresh_database_request');
                                                        setState(() => _model
                                                                .firestoreRequestCompleter2 =
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return Padding(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'MAIN_TRACKER_Container_c3v34261_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_bottom_sheet');
                                                                await showModalBottomSheet(
                                                                  isScrollControlled:
                                                ...
                                                child: FutureBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return RefreshIndicator(
                                                      onRefresh: () async {
                                                        logFirebaseEvent(
                                                            'MAIN_TRACKER_ListView_0w30wk84_ON_PULL_T');
                                                        logFirebaseEvent(
                                                            'ListView_refresh_database_request');
                                                        setState(() => _model
                                                                .firestoreRequestCompleter1 =
