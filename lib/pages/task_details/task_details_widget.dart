          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('TASK_DETAILS_arrow_back_rounded_ICN_ON_T');
                                  ...
                                  child: FutureBuilder<ProjectsRecord>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'TASK_DETAILS_PAGE_Row_scf3ysfz_ON_TAP');
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'TASK_DETAILS_PAGE_person_add_ICN_ON_TAP');
                                          logFirebaseEvent(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TASK_DETAILS_add_comment_rounded_ICN_ON_');
                                ...
                                if (widget.taskRef!.status == 'In Progress')
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'TASK_DETAILS_PAGE_markComplete_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                if (widget.taskRef!.status == 'Not Started')
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'TASK_DETAILS_PAGE_accept_ON_TAP');
                                        logFirebaseEvent('accept_backend_call');
                                        ...
                                        logFirebaseEvent('accept_navigate_to');
