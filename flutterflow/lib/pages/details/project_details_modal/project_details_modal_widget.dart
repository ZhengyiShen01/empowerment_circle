...
import '/pages/details/members_modal/members_modal_widget.dart';
...
import 'project_details_modal_model.dart';
export 'project_details_modal_model.dart';

class ProjectDetailsModalWidget extends StatefulWidget {
  const ProjectDetailsModalWidget({
    Key? key,
    this.projectRef,
  }) : super(key: key);
  ...
  @override
  _ProjectDetailsModalWidgetState createState() =>
      _ProjectDetailsModalWidgetState();
}

class _ProjectDetailsModalWidgetState extends State<ProjectDetailsModalWidget>
    with TickerProviderStateMixin {
  late ProjectDetailsModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetailsModalModel());
              ...
              children: [
                    ...
                    children: [
                                  ...
                                  if (widget.projectRef!.owner ==
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'PROJECT_DETAILS_MODAL_edit_rounded_ICN_O');
                                          logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'PROJECT_DETAILS_MODAL_close_rounded_ICN_');
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROJECT_DETAILS_MODAL_Row_bo06fybw_ON_TA');
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                updateCount: (count) async {
                                  ...
                                  logFirebaseEvent(
                                      'PROJECT_DETAILS_MODAL_CountController_i8');
                                  logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                updateCount: (count) async {
                                  ...
                                  logFirebaseEvent(
                                      'PROJECT_DETAILS_MODAL_CountController_mw');
                                  logFirebaseEvent(
                                      'CountController_backend_call');
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROJECT_DETAILS_MODAL_Container_vysw9jxy');
                                                logFirebaseEvent(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROJECT_DETAILS_MODAL_Container_cj8cngnk');
                                                logFirebaseEvent(
                                                    'Container_bottom_sheet');
                                                await showModalBottomSheet(
                                                  isScrollControlled: true,
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'PROJECT_DETAILS_MODAL_Container_bhjlux9n');
                                                  logFirebaseEvent(
                ...
                if (widget.projectRef!.owner == currentUserReference)
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'PROJECT_DETAILS_MODAL_ADD_CHALLENGE_BTN_');
