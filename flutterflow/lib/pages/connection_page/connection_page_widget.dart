...
class ConnectionPageWidget extends StatefulWidget {
  ...
  @override
  _ConnectionPageWidgetState createState() => _ConnectionPageWidgetState();
}
...
class _ConnectionPageWidgetState extends State<ConnectionPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ConnectionPage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CONNECTION_ConnectionPage_ON_INIT_STATE');
      logFirebaseEvent('ConnectionPage_update_widget_state');
      setState(() {
          ...
          child: Scaffold(
            ...
            floatingActionButton: Visibility(
              ...
              child: FloatingActionButton(
                onPressed: () async {
                  logFirebaseEvent('CONNECTION_FloatingActionButton_zmge0u97');
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'CONNECTION_Container_0uolrxij_ON_TAP');
                                                  logFirebaseEvent(
                                                      'userCard_navigate_to');
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'CONNECTION_search_rounded_ICN_ON_TAP');
                                                logFirebaseEvent(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    return Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'CONNECTION_PAGE_PAGE_userList_5_ON_TAP');
                                                          if (MediaQuery.of(
                                                                      context)
                                                                  .size
                                                                  .width >=
