                                      ...
                                      children: [
                                        ...
                                        if (responsiveVisibility(
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_close_rounded_ICN_ON_TAP');
                                              logFirebaseEvent(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PROFILE_Container_27u6cbxt_ON_TAP');
                                          logFirebaseEvent(
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PROFILE_Container_8ugi70t6_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_navigate_to');
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PROFILE_Container_u9xx6nxq_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_backend_call');

                                          var checkoutSessionsRecordReference =
                                              CheckoutSessionsRecord.createDoc(
                                                  currentUserReference!);
                                          await checkoutSessionsRecordReference
                                              .set(
                                                  createCheckoutSessionsRecordData(
                                            price:
                                                'price_1NNK5cH9hnRIC1cVGVT4zeMO',
                                            successUrl:
                                                'https://wecaresocio.com',
                                          ));
                                          _model.docRef = CheckoutSessionsRecord
                                              .getDocumentFromData(
                                                  createCheckoutSessionsRecordData(
                                                    price:
                                                        'price_1NNK5cH9hnRIC1cVGVT4zeMO',
                                                  ...
                                                  checkoutSessionsRecordReference);
                                          logFirebaseEvent(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_BUY_ME_A_COFFEE_BTN_ON_TAP');
                                              logFirebaseEvent(
