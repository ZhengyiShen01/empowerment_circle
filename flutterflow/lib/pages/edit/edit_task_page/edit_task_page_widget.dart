...
class _EditTaskPageWidgetState extends State<EditTaskPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditTaskPage'});
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('EDIT_TASK_close_rounded_ICN_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'eymba6m1' /* Enter description here... */,
                                      ),
                            ...
                            children: [
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'EDIT_TASK_SAVE_CHANGES_BTN_ON_TAP');
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'You have updated the challenge!',
                                          style: FlutterFlowTheme.of(context)
                                              .titleMedium
                                              .override(
                                                fontFamily:
