...
class EditProjectPageWidget extends StatefulWidget {
  ...
  @override
  _EditProjectPageWidgetState createState() => _EditProjectPageWidgetState();
}
...
class _EditProjectPageWidgetState extends State<EditProjectPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditProjectPage'});
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('EDIT_PROJECT_close_rounded_ICN_ON_TAP');
                            ...
                            children: [
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'EDIT_PROJECT_SAVE_CHANGES_BTN_ON_TAP');
