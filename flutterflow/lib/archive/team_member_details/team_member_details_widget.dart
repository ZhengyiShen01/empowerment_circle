...
class _TeamMemberDetailsWidgetState extends State<TeamMemberDetailsWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'teamMemberDetails'});
    setupAnimations(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('TEAM_MEMBER_DETAILS_arrow_back_rounded_I');
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'TEAM_MEMBER_DETAILS_Container_81w6qb0z_O');
