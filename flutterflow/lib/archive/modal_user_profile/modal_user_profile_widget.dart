                      ...
                      children: [
                            ...
                            children: [
                              ...
                              if (widget.userRef!.reference !=
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'MODAL_USER_PROFILE_CONNECT_BTN_ON_TAP');
                                    ...
                                    await ActivityRecord.collection.doc().set({
                                      ...createActivityRecordData(
                                        activityName: 'Connection Invitation',
                        ...
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MODAL_USER_PROFILE_close_rounded_ICN_ON_');
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MODAL_USER_PROFILE_Container_a471l7kv_ON');
