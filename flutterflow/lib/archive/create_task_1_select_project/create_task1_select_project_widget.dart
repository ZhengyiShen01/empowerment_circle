...
class _CreateTask1SelectProjectWidgetState
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'createTask_1_SelectProject'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CREATE_TASK_1_SELECT_PROJECT_createTask_');
      logFirebaseEvent('createTask_1_SelectProject_refresh_datab');
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'CREATE_TASK_1_SELECT_PROJECT_close_round');
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_TASK_1_SELECT_PROJECT_ADD_PROJECT');
                      ...
                      child: FutureBuilder<List<ProjectsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return RefreshIndicator(
                            onRefresh: () async {
                              logFirebaseEvent(
                                  'CREATE_TASK_1_SELECT_PROJECT_ListView_ln');
                              logFirebaseEvent(
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'CREATE_TASK_1_SELECT_PROJECT_Container_y');
