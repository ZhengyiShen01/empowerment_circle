              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'TEAM_MEMBERS_search_rounded_ICN_ON_TAP');
                              ...
                              child: StreamBuilder<UsersRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'TEAM_MEMBERS_Container_lgm11l1e_ON_TAP');
                                      logFirebaseEvent(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'TEAM_MEMBERS_PAGE_REMOVE_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_backend_call');
                    ...
                    child: FutureBuilder<List<UsersRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return RefreshIndicator(
                          onRefresh: () async {
                            logFirebaseEvent(
                                'TEAM_MEMBERS_ListView_14zoxmyj_ON_PULL_T');
                            logFirebaseEvent(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'TEAM_MEMBERS_PAGE_userList_5_ON_TAP');
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'TEAM_MEMBERS_PAGE_ASSIGN_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_backend_call');
